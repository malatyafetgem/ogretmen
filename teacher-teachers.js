...
function teacherTableHtml(rows,{actions=false}={}){
  ...
  return `<thead><tr><th>#</th><th>Ad Soyad</th><th class="tc-print-col">T.C. Kimlik No</th><th>Branş</th><th>Rol</th><th>Telefon</th><th>E-posta</th><th>Sınıf</th><th>Nöbet</th><th>Ders</th><th>Görev</th>${actions?'<th class="no-print">İşlem</th>':''}</tr></thead><tbody>${rows.map((t,i)=>{
